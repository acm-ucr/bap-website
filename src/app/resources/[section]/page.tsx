        ...
        <div className="pb-16 pl-14 pr-[10%]">
          ...
          <ul className="list-disc pl-11">
            <li className="text-left font-sans text-xl font-thin text-white">
              ...
              customer service, and think on your feet. These valuable soft
              skills are frequently listed in job requirements and are what
          ...
          <ul className="list-disc pl-11">
            <li className="text-left font-sans text-xl font-thin text-white">
              ...
              font, size, and alignment, and avoid using color. Double-check for
          ...
          <ul className="list-disc pl-11">
            <li className="text-left font-sans text-xl font-thin text-white">
              ...
              through leadership roles, volunteer work, and other job
              experiences.
            </li>
          </ul>
        </div>
    ...
    case "prof":
      return (
        <div className="max-w-7xl pb-10 pl-14">
          ...
          <p className="pt-3 text-left font-sans text-xl font-thin text-white">
            Most of our meetings are speaker events with firms. These events are
            a great opportunity to get to know the recruiters and professionals.
