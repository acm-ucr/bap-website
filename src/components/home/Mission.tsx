...
const Mission = () => {
  return (
    <div className="flex w-full flex-col items-center md:relative">
      ...
      <div className="bottom-[10%] left-1/2 my-[-10%] flex h-[100px] w-[70%] transform items-center justify-center bg-[#b4966f] p-4 text-center text-lg font-semibold text-white shadow-5xl md:absolute md:my-0 md:-translate-x-1/2 md:bg-[#b4966fa4] md:text-2xl md:font-normal md:shadow-none">
